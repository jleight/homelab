terraform {
  source = "${get_parent_terragrunt_dir()}/../modules//servarr/radarr"
}
...
inputs = {
  ...
  db_username = dependency.db.outputs.radarr_username
  db_password = dependency.db.outputs.radarr_password
}
