terraform {
  source = "${get_parent_terragrunt_dir()}/../modules//sdr/tar1090"
}
...
inputs = {
  ...
  readsb_host = dependency.readsb.outputs.service_host
  readsb_port = dependency.readsb.outputs.service_port

  dump978_host     = dependency.dump978.outputs.service_host
  dump978_uat_port = dependency.dump978.outputs.uat_port
}
